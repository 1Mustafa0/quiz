    ...
    <div className="space-y-24 py-12">
      ...
      <section className="text-center space-y-8 max-w-4xl mx-auto">
        <motion.div
          ...
          className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-50 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 text-sm font-medium border border-indigo-100 dark:border-indigo-800"
        >
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white tracking-tight leading-tight"
        >
          Transform Your Content into <span className="text-indigo-600 dark:text-indigo-400">Interactive Quizzes</span>
        </motion.h1>
        ...
        >
          ...
          <Link
            to="/library"
            className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 border border-gray-200 dark:border-slate-600 text-lg font-semibold rounded-xl text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 shadow-md hover:shadow-lg transition-all transform hover:-translate-y-1"
          >
            Browse Quizzes
          </Link>
        </motion.div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {features.map((feature, index) => (
          <motion.div
            ...
            className="p-8 bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow group"
          >
      ...
      {/* Stats */}
      <section className="bg-indigo-600 dark:bg-indigo-700 rounded-3xl p-12 text-center text-white space-y-8">
